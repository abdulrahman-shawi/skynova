...
const OrderLayout: React.FunctionComponent<IOrderLayoutProps> = (props) => {
    ...
    const CANCEL_REASON_STATUSES = new Set(["فشل التسليم مرتجع", "تم الغاء الطلب", "تم إلغاء الطلب", "معلق / نقص معلومات"]);
    ...
    return (
        <div className="">
            ...
            {/* مودال سبب الإلغاء / فشل التسليم / التعليق */}
            <AppModal
                ...
                title={cancelReasonTarget?.status === "معلق / نقص معلومات" ? "سبب التعليق / نقص المعلومات" : "سبب الإلغاء / فشل التسليم"}
            ...
            >
                <div>
                    <label className="block text-sm font-bold mb-2 text-slate-700 dark:text-slate-200">
                        {cancelReasonTarget?.status === "معلق / نقص معلومات" ? "سبب التعليق" : "سبب الإلغاء"}
                    </label>
                    <textarea
                        rows={3}
                        ...
                        placeholder={cancelReasonTarget?.status === "معلق / نقص معلومات" ? "اكتب سبب تعليق الطلب أو المعلومات الناقصة..." : "اكتب سبب فشل التسليم أو إلغاء الطلب..."}
                        value={cancelReason}
